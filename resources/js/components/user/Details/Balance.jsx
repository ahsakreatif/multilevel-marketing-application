...
const Balance = ({ details }) => {
    ...
    const projects = [
        ...
        {
            name: "Total Withdraw",
            count: details?.total_withdraw ? (Number(details?.total_withdraw)).toFixed(2) : 0.00,
            suffix: "TK",
            initials: "TW",
            bgColor: "bg-rose-600",
        },
        {
            ...
            count: details?.purchase_amount ? (Number(details?.purchase_amount)).toFixed(2) : 0.00,
            suffix: "",
            initials: "PP",
            bgColor: "bg-gray-800",
        },
        {
            ...
            count: details?.total_today_bonus ? (Number(details?.total_today_bonus)).toFixed(2) : 0.00,
            suffix: "TK",
            initials: "TDC",
            bgColor: "bg-sky-500",
        },
        {
            ...
            count: details?.referral_bonus||0,
            suffix: "TK",
            initials: "TRC",
        ...
        },
        {
            ...
            count: details?.matching_bonus||0,
            suffix: "TK",
            initials: "TMC",
