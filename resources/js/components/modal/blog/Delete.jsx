...
import { deleteBlog } from '../../../hooks/queries/blog';

export default function DeleteSlider({isOpen, setIsOpen, closeModal, refetch, blog}) {


    const onSubmit= (data) => {
        deleteBlogMutate(data)
    }
                ...
                <div className="inline-block w-full max-w-2xl pb-4 overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-[3px]">
                    ...
                    <div className="flex items-center bg-teal-700 text-white py-4 px-4 mb-6 font-medium text-lg text-left rounded-t-[3px]">
                        ...
                        <div className='px-6'>
                                ...
                                <h2 className="text-lg font-semibold pb-5">Delete this Blog </h2>
                                <p className="text-gray-500 text-sm">
                                    Are you sure you want to delete this Blog All of your data will
