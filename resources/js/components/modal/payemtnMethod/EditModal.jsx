...
import { updatePaymentMethod } from '../../../hooks/queries/paymentMethod';

export default function EditModal({isOpen, setIsOpen, closeModal, refetch, payment}) {
    ...
    const {
        ...
        isLoading,
    } = useMutation(updatePaymentMethod, {
        onSuccess: (data) => {
            toast.success(data, {
                position: 'top-right'
            });
                                ...
                                <Textinput
                                    ...
                                    <div className='flex justify-end mt-4'>
                                        ...
                                        {isLoading ? (
                                            ...
                                            <input type="submit" value="Update" className=' cursor-pointer bg-teal-700 text-white font-normal px-4 py-1 rounded-md' />
                                        )}
                                        </div>
