...
export default function CreateModal({
    ...
    const { mutate: createRewardMutate, isLoading } = useMutation(
        createReward,
        {
            onSuccess: (data) => {
                toast.success(data, {
                                        ...
                                        <form onSubmit={handleSubmit(onSubmit)}>
                                            <div className=" w-3/4 mx-auto">
                                                ...
                                                <div className="col-span-12 formGroup">
                                                    ...
                                                    ></textarea>
                                                    {backendError?.travel_destination ?? (
