...
import { deleteContact } from "../../../hooks/queries/contact";
...
export default function DeleteContact({
    ...
    const onSubmit = (data) => {
        deleteContactMutate(data);
    };
    function closeModal() {
        setIsOpen(false);
    }

    const { mutate: deleteContactMutate, isLoading } = useMutation(
        deleteContact,
        {
            onSuccess: (data) => {
                toast.success(data, {
                                    ...
                                    <div className="px-6">
                                        <div className=" w-3/4 mx-auto">
                                            ...
                                            <p className="text-gray-500 text-sm">
                                                ...
                                                this Contact? All of your data will
                                            ...
                                            <div className="flex justify-end mt-4">
                                                <div className="mr-3">
                                                    {isLoading ? (
                                                        <>
                                                            <button
                                                                className="btn btn-danger flex justify-center align-center"
                                                                type="button"
                                                                disabled
                                                            >
                                                                <svg
                                                ...
                                                <div
                                                    onClick={closeModal}
                                                    className=" bg-teal-700 text-white font-normal px-4 py-1 rounded-md cursor-pointer"
                                                >
