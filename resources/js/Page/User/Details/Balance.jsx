            ...
            <div className="shadow sm:overflow-hidden sm:rounded-md">
                ...
                <div className="bg-gray-200 px-4 py-3 text-right sm:px-6">
                    ...
                    </button> */}
                    {
                        ...
                        ?
                        <>
                            <button className="rounded-md border border-transparent bg-teal-600 py-2 px-4 text-sm font-medium text-white shadow-sm hover:bg-teal-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 flex justify-center align-center" type="button" disabled>
