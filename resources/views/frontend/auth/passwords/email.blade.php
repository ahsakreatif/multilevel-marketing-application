            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="email" type="email" class="form-control ring-1 ring-teal-600 @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email" autofocus>
