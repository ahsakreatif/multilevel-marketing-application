            ...
            <div class="card-body">
                ...
                <form method="POST" action="{{ route('password.confirm') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="password" type="password" class="form-control ring-1 ring-teal-600 @error('password') is-invalid @enderror" name="password" required autocomplete="current-password">
